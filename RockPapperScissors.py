...
tk.Label(window, bg='lightblue', text="Your Choice:").pack(pady=5)
tk.Label(window, bg='lightblue', textvariable=user_var, font=('Helvetica', 14)).pack(pady=5)
tk.Label(window, bg='lightblue', text="Program's Choice:").pack(pady=5)
tk.Label(window, bg='lightblue', textvariable=program_var, font=('Helvetica', 14)).pack(pady=5)
tk.Label(window, bg='lightblue', text="Result:").pack(pady=5)
tk.Label(window, bg='lightblue', textvariable=result_var, font=('Helvetica', 14)).pack(pady=5)
